  ...
  return (
    <form onSubmit={handleSubmit} className='flex justify-center items-center h-screen'>
      <fieldset className="fieldset bg-blueDeep border-base-800 text-lightOcre rounded-box w-sm border p-10">
        <legend className="fieldset-legend text-lightOcre">Register</legend>
        ...
        <button className="btn text-lightOcre bg-blueSteel mt-4" disabled={isRegistering}>{isRegistering ? <LoaderIcon className='w-full h-5 animate-spin text-center' /> : 'Register'}</button>
